...
function addItemToCart(title, price, imageSrc) {
  ...
  var cartRow2 = cartRow.classList.add('cart-row2');
  var cartItems = document.getElementsByClassName('cart-items')[0];
  ...
  cartRow2.innerHTML = cartRowContents;
  cartItems.append(cartRow);
  cartRow2
    .getElementsByClassName('btn-danger')[0]
    .addEventListener('click', removeCartItem);
...
function goToPayment() {
  ...
  // document.getElementsByClassName('cart-column')[0].innerHTML = 'PODSUMOWANIE';
  // document.getElementsByClassName('cart-column')[1].style.display = 'none';
  // document.getElementsByClassName('cart-column')[2].style.display = 'none';
}
