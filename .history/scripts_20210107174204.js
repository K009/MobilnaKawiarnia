...
let shakeDescription = 'mleczny napój serwowany na zimno, często z dodatkiem lodów. Istnieje wiele jego wersji, o różnych smakach, m.in.: waniliowy, czekoladowy, truskawkowy, bananowy, kokosowy, pistacjowy, jagodowy itp. Wersją shakea bez mleka jest smoothie.'
let applePieDescription = 'pochodzący z Francji wyrób cukierniczy, wynalazek przypisywany Marie-Antoine'owi Carême'owi, składający się z półkruchego lub kruchego ciasta oraz owoców. Carême miał stworzyć ciasto o nazwie charlotte russe specjalnie dla cara Aleksandra I, swego wieloletniego pracodawcy.'
